...
test.describe('Beauty — full-kit stack (fit 100 + stylish makeup + all tattoos)', () => {
  ...
  test('via fitUp cheat: stylish makeup + all tattoos leaves beauty positive', async ({ game: page }) => {
  ...
  test('via natural training: stylish makeup + all tattoos leaves beauty positive', async ({ game: page }) => {
    await setVar(page, 'mc.fit', 0);
  ...
  test('repeated shower→reapply stylish makeup never drops beauty below 0', async ({ game: page }) => {
